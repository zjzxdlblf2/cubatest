...
public class WzglTestContainer extends TestContainer {

    public WzglTestContainer() {
        super();
    ...
    public static class Common extends WzglTestContainer {

        public static final WzglTestContainer.Common INSTANCE = new WzglTestContainer.Common();
