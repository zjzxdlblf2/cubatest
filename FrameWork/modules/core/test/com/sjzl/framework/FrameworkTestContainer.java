...
public class FrameworkTestContainer extends TestContainer {

    public FrameworkTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/sjzl/framework/app.properties",
    ...
    public static class Common extends FrameworkTestContainer {

        public static final FrameworkTestContainer.Common INSTANCE = new FrameworkTestContainer.Common();
